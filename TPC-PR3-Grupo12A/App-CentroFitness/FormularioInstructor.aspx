...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .lista-disciplinas {
            ...
            .lista-disciplinas td {
                padding: 8px 14px;
            }

            .lista-disciplinas input[type="checkbox"] {
                margin-right: 8px;
                transform: scale(1.1);
            }

            .lista-disciplinas label {
                margin-bottom: 0;
                cursor: pointer;
            }
    </style>
                ...
                <div class="card shadow p-4">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <small class="text-muted d-block mb-2">Seleccione una o más disciplinas que dicta el instructor.
                            </small>

                            <div class="border rounded p-3 bg-light">

                                <asp:CheckBoxList ID="cblDisciplinas"
                                    runat="server"
                                    CssClass="lista-disciplinas"
                                    RepeatColumns="3"
