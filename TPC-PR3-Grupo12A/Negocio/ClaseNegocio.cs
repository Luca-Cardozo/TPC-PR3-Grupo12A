...
namespace Negocio
{
    public class ClaseNegocio
    {
        ...
        public void cambiarEstadoClase(int idClase, EstadoClase estado)
        {
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                ...
                datos.setearParametro("@Estado", (int)estado);
                datos.setearParametro("@IdClase", idClase);
        ...
        public List<Clase> listarVigentesPorInstructor(int idInstructor)
        {
            List<Clase> lista = new List<Clase>();
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                ...
                datos.setearParametro("@Estado", (int)EstadoClase.Vigente);
